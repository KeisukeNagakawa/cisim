...
First, you need to install these packages; cerberus(for validating args), scipy(optimiziation), and numpy(for calculation). And after that, pip install cisim.

shell

.. code-block:: shell

    pip install cerberus scipy numpy
    pip install cisim
